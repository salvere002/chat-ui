...
const MessageList: React.FC<MessageListProps> = ({ messages, chatId, onMessagePairCapture, compact = false }) => {
  const { 
        ...
        >
          ...
          {messages.length > 0 &&
            ...
            messages[messages.length - 1].isComplete !== false && (
              <div className={`w-full flex justify-center px-2 pb-8 ${!compact ? 'sm:px-4' : ''}`}>
