              ...
              {chats.length > 0 && (
                ...
                >
                  <button
                    ...
                    className={`absolute inset-x-3 top-3 bottom-3 text-xs font-medium rounded-md flex items-center justify-center gap-2 bg-transparent text-text-tertiary border border-border-primary hover:bg-bg-tertiary hover:text-error hover:border-error transition-opacity duration-300 ease-in-out ${collapsed
                  ...
                  >
                    ...
                    <span
                      className={`whitespace-nowrap text-xs ${collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100 w-auto'
                        }`}
                      style={{
                        transition: 'opacity 150ms ease-out, width 300ms ease-out',
                        transitionDelay: collapsed ? '0ms' : '150ms'
